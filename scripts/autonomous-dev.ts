...
switch (command) {
  case "pick": {
    ...
    if (result.success && result.task) {
      ...
      console.log(`::set-output name=task_id::${result.task.id}`);
      console.log(`::set-output name=task_title::${result.task.title}`);
      console.log(`::set-output name=has_task::true`);
      ...
      console.log(`::set-output name=has_task::false`);
      console.log(`::set-output name=skip_reason::${result.reason}`);
