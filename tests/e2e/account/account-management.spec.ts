...
test.describe('Account - Profile Display', () => {
  ...
  test('should display user name', async ({ page }) => {
    ...
    await expect(page.locator(`text=${testData.users.testUser.name}`)).toBeVisible()
  })
  ...
  test('should display user email', async ({ page }) => {
    ...
    await expect(page.locator(`text=${testData.users.testUser.email}`)).toBeVisible()
  })
  ...
  test('should have edit profile button', async ({ page }) => {
    ...
    const editButton = page.locator('a[href="/account/edit"], button:has-text("編集")')
...
test.describe('Account - Edit Profile', () => {
  ...
  test('should have save and cancel buttons', async ({ page }) => {
    ...
    const cancelButton = page.locator('a[href="/account"], button:has-text("キャンセル")')
...
test.describe('Account - Profile Completeness', () => {
  ...
  test('should show all profile fields', async ({ page }) => {
    ...
    const hasName = await page.locator(`text=${testData.users.testUser.name}`).isVisible()
    const hasEmail = await page.locator(`text=${testData.users.testUser.email}`).isVisible()
