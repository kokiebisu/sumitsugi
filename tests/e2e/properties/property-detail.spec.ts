...
test.describe('Property Detail Page @properties @critical', () => {
  test('should display property detail page with all sections', async ({
    propertyDetailPage,
  }) => {
  ...
  test('should display image gallery with multiple images', async ({
    propertyDetailPage,
  }) => {
    await propertyDetailPage.goto(testData.properties.bohemian);
  ...
  test('should display property information section', async ({
    propertyDetailPage,
    page,
  }) => {
    await propertyDetailPage.goto(testData.properties.bohemian);
  ...
  test('should display furniture section with handover items', async ({
    propertyDetailPage,
  }) => {
    await propertyDetailPage.goto(testData.properties.bohemian);
  ...
  test('should display location map section', async ({
    propertyDetailPage,
    page,
  }) => {
    await propertyDetailPage.goto(testData.properties.bohemian);
    ...
    await expect(page.locator('h2:text("ロケーション")')).toBeVisible({
      timeout: 10000,
    });
  });

  test('should have back link to return to listings', async ({
    propertyDetailPage,
    page,
  }) => {
    await propertyDetailPage.goto(testData.properties.bohemian);
...
test.describe('Property Detail - Different Property Types @properties @extended', () => {
  test('should display DJ/Producer property correctly', async ({
    propertyDetailPage,
  }) => {
  ...
  test('should display vintage property correctly', async ({
    propertyDetailPage,
  }) => {
