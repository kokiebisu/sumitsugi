...
test.describe('Dashboard - Empty State', () => {
  ...
  test('should show empty state when user has no inquiries', async ({ page }) => {
    await page.goto('/dashboard')
...
test.describe('Dashboard - With Inquiries', () => {
  ...
  test('should show inquiry status', async ({ page }) => {
    ...
    const statusIndicator = page.locator('text=/申し込み|確認中|承認済み|pending|reviewing/')
  ...
  test('should show progress steps', async ({ page }) => {
    ...
    const progressElements = page.locator('text=/申し込み|確認中|承認済み|内見/')
  ...
  test('should show next action message', async ({ page }) => {
    ...
    const actionMessage = page.locator('text=/お待ちください|ご連絡|確認|準備/')
...
test.describe('Dashboard - Navigation', () => {
  ...
  test('should be accessible from header menu when logged in', async ({ page, authPage }) => {
    await page.goto('/')
