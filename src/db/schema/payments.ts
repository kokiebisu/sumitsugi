import { pgTable, uuid, varchar, integer, timestamp, jsonb, text, boolean, index } from "drizzle-orm/pg-core";
...
export const payments = pgTable("payments", {
  ...
  return {
    ...
    stripePaymentIntentIdIdx: index("idx_payments_stripe_payment_intent_id").on(table.stripePaymentIntentId),
  };
});
...
export const transactions = pgTable("transactions", {
  ...
  return {
    ...
    recipientTypeIdx: index("idx_transactions_recipient_type").on(table.recipientType),
    recipientIdIdx: index("idx_transactions_recipient_id").on(table.recipientId),
...
export const stripeAccounts = pgTable("stripe_accounts", {
  ...
  return {
    ...
    stripeAccountIdIdx: index("idx_stripe_accounts_stripe_account_id").on(table.stripeAccountId),
  };
});
