  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        >
          内見予定 (
          {inquiries.filter((i) => i.status === 'viewing_scheduled').length})
        </Button>
        <Button
          variant={
            filterStatus === 'contract_in_progress' ? 'default' : 'outline'
          }
          size="sm"
        ...
        >
          契約手続き中 (
          {inquiries.filter((i) => i.status === 'contract_in_progress').length})
        </Button>
        <Button
            ...
            >
              ...
              <div className="mb-4 grid gap-3 md:grid-cols-2">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <a
                    href={`mailto:${inquiry.applicantEmail}`}
