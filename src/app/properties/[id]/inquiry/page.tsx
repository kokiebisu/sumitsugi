        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mb-8 flex gap-4 rounded-xl border border-border bg-background p-4">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h2 className="font-medium text-foreground line-clamp-2">{property.title}</h2>
            </div>
          </div>

          {/* Form Section */}
          <div className="rounded-xl border border-border bg-background p-6 shadow-sm md:p-8">
            <h1 className="mb-2 text-xl font-semibold text-foreground md:text-2xl">この暮らしに興味がある</h1>
          ...
          <div className="mt-6 flex gap-3 rounded-lg bg-warm-gray-50 p-4">
            ...
            <div className="text-xs leading-relaxed text-muted-foreground">
              <p className="mb-1 font-medium text-foreground">このフォームの目的</p>
              <p>
