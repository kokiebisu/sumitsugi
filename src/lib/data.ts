...
// 引き継ぎ対象の大型家具
export type LargeFurnitureType =
  | 'bed'
  | 'sofa'
  | 'desk'
  | 'table'
...
// 引き継ぎ対象の大型家電
export type LargeApplianceType =
  | 'washer'
  | 'dryer'
  | 'ac'
  | 'microwave'
...
export const properties: Property[] = [
  {
    ...
    summary:
      'カラフルなタペストリーと50以上の植物。レコードを聴きながら、自分らしい空間を作り上げてきた暮らしです。',
    images: [
    ...
    conditions:
      '植物の世話ができる方。アートやカルチャーが好きな方だと嬉しいです。',
    handoverFee: 60000,
    rent: 85000,
    managementFee: 5000,
    deposit: 1,
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason:
            '北欧ヴィンテージのサイドテーブル。デンマークで見つけた1960年代のチーク材で、経年変化が美しい一品',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2026/01/1H8A5776-1.jpg',
        },
        {
          reason:
            'IKEAで購入したモジュラーシェルフをカスタム。植物とアート作品をバランスよく配置できます',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2026/01/1H8A5798-1.jpg',
        },
        {
          reason:
            '友人のアーティストに特注したフロアランプ。真鍮と和紙で柔らかな光を演出',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2026/01/1H8A5790-1-880x587.jpg',
        },
      ],
      messageToNext:
        'この部屋は、私にとってただの住まいではなく、クリエイティブな実験室でした。窓から見える目黒川の四季、壁に映る朝日の影、夜の静けさ。すべてが作品作りのインスピレーションになりました。次に住む方にも、この空間で自分だけの物語を紡いでほしいです。植物たちも、きっとあなたを歓迎してくれるはず。',
      socialLinks: {
    ...
    faq: [
      {
        ...
        answer:
          'はい、水やりの頻度など詳しく引き継ぎます。ほとんどが丈夫な品種なので、初心者の方でも安心して育てられます。',
      },
      {
        question: 'レコードプレーヤーの使い方を教えてもらえますか？',
        answer:
          'もちろんです。引き継ぎ時に使い方を丁寧にレクチャーします。レコードも一部そのままお使いいただけます。',
      },
      {
        question: '友人を泊めることはできますか？',
        answer:
          'はい、可能です。ただし長期滞在の場合は大家さんへの連絡をお願いします。',
      },
      {
        question: 'インテリア購入料の支払い方法は？',
        answer:
          '銀行振込または分割払いに対応しています。詳細は相談時にご説明します。',
      },
    ],
  },
  {
    ...
    summary:
      '打ちっぱなしのコンクリート壁と防音対策。ターンテーブルと機材に囲まれた音楽制作の拠点です。',
    images: [
    ...
    keyMoney: 1,
    area: '東京',
    location: { lat: 35.658, lng: 139.7016, neighborhood: '渋谷区恵比寿' },
    layout: '1LDK',
    occupancy: 1,
    style: 'industrial',
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason:
            'オーダーメイドのDJブース。ウォールナット無垢材で職人に作ってもらった一点もの',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/12/OHZM7581-1.jpg',
        },
        {
          reason:
            'イームズのラウンジチェア。中古で見つけたオリジナル。レコードを聴きながらくつろぐ定位置',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/12/OHZM7727-1.jpg',
        },
        {
          reason:
            'インダストリアルなスチールラック。500枚以上のレコードを収納。見せる収納として',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/12/OHZM7664-1.jpg',
        },
      ],
      messageToNext:
        'この部屋で無数のトラックを作り、週末には友人を呼んでセッションを重ねてきました。コンクリートの壁に反響する音、機材に囲まれた空間。音楽を本気で愛する人には、これ以上ない環境です。レコードコレクションの一部も引き継ぎますので、ぜひこの空間で新しいサウンドを生み出してください。',
      socialLinks: {
    ...
    faq: [
      {
        ...
        answer:
          'もちろん可能です。ただ、音楽が好きな方、これから始めたい方におすすめの空間です。',
      },
      {
        question: 'DJ機材の使い方を教えてもらえますか？',
        answer:
          'はい、基本的な使い方は引き継ぎ時にレクチャーします。また、おすすめの練習方法もお伝えします。',
      },
      {
        question: '深夜に音を出しても本当に大丈夫ですか？',
        answer:
          '防音対策済みですが、22時以降は音量を控えめにしていただくのがマナーです。通常のヘッドホン使用であれば問題ありません。',
      },
      {
        question: 'レコードも全て引き継げますか？',
        answer:
          '約200枚のうち、150枚程度は引き継ぎ可能です。一部ヴィンテージの貴重盤は持っていく予定ですが、リストは相談時にお見せします。',
      },
    ],
  },
  {
    ...
    summary:
      '昭和の雰囲気漂うレトロな家具と、温かみのある照明。時間がゆっくり流れる空間です。',
    images: [
    ...
    keyMoney: 0,
    area: '東京',
    location: { lat: 35.709, lng: 139.6651, neighborhood: '杉並区高円寺' },
    layout: '1K',
    occupancy: 1,
    style: 'vintage',
    furniture: ['bed', 'desk', 'storage'],
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '昭和30年代の木製デスク。味わい深い色合いが気に入っています',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/11/009_OHZM9458-1-880x586.jpg',
        },
        {
          reason: 'アンティークの照明。温かみのある光が部屋全体を包みます',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/11/028_OHZM9580-1.jpg',
        },
        {
          reason: '古書店で見つけた本棚。長年の使用感が美しい',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/11/012_OHZM9485-1.jpg',
        },
      ],
      messageToNext:
        '古いものには、新しいものにはない温かさがあります。この部屋で過ごす時間がゆっくり流れるように感じられるのは、そんな家具たちのおかげかもしれません。次の方にも、この空間の心地よさを感じてもらえたら嬉しいです。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '広いリビングとアート作品。創作活動をしながら、自分だけの世界観を作ってきた空間です。',
    images: [
    ...
    conditions:
      '創作活動をされている方優先。作品制作に使っていただいて構いません。',
    handoverFee: 80000,
    rent: 150000,
    managementFee: 10000,
    deposit: 2,
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'アルコランプ。部屋のシンボル的存在で、柔らかな光が好き',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/OHZM8551-1-880x586.jpg',
        },
        {
          reason: '壁に飾った自作の大きな絵画。この部屋で描きました',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/OHZM8779-1-880x586.jpg',
        },
        {
          reason:
            'ネイティブアメリカン柄のベッドカバー。古着屋で見つけたお気に入り',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/OHZM8632-1.jpg',
        },
      ],
      messageToNext:
        'この部屋は私にとってキャンバスのようなものでした。窓から入る光、壁の色、すべてがインスピレーションの源です。次に住む方にも、ここで何か新しいものを生み出してほしいです。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      'むき出しの配管とコンクリート。倉庫をリノベーションした無骨な空間です。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'アイアンフレームのベッド。無骨さが気に入っています',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250927_01-2.jpeg',
        },
        {
          reason: '工業用照明。本物の工場で使われていたものを再利用',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250927_02-1.jpg',
        },
        {
          reason:
            '古い作業台をリメイクしたデスク。長時間の作業にも耐える頑丈さ',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250927_03-1.jpg',
        },
      ],
      messageToNext:
        'ものづくり���する人にとって、この空間は最高の環境だと思います。無骨なコンクリートの壁が、かえって創造力を刺激してくれる。次の方も、ここで素晴らしい作品を生み出してください。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '白を基調とした清潔感のある空間。必要最小限のもので暮らすミニマリストの部屋です。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '白いベッドフレーム。シンプルさの極み',
          image: 'https://www.mensnonno.jp/wp-content/uploads/2025/09/01.jpg',
        },
        {
          reason: '間接照明。必要最低限の光で落ち着く空間に',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250928_03.jpg',
        },
        {
          reason: 'シンプルなデスク。集中できる作業環境',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250928_04.jpg',
        },
      ],
      messageToNext:
        'ミニマルな暮らしは、自分にとって必要なものを見極める練習でもあります。この白い空間で、あなたも本当に大切なものと向き合ってみてください。',
      socialLinks: {
  ...
  },
  {
    ...
    title: 'ボヘミアンスタイルの隠れ家',
    summary:
      '世界中で集めたテキスタイルと雑貨。旅するように暮らしてきた空間です。',
    images: [
    ...
    conditions:
      'エスニック雑貨を大切にしてくれる方。猫を飼っていた名残があります。',
    handoverFee: 40000,
    rent: 68000,
    managementFee: 3000,
    deposit: 1,
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'モロッコのラグ。マラケシュのスークで一目惚れ',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250929_01.jpg',
        },
        {
          reason: 'インドの布。ジャイプールで見つけた手染めの美しい生地',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250929_02.jpg',
        },
        {
          reason: 'タイで買った照明。チェンマイの職人さんが作ったもの',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250929_03.jpg',
        },
      ],
      messageToNext:
        'この部屋の雑貨には、それぞれ旅の思い出が詰まっています。でも、次の住人にも新しい物語を紡いでほしい。旅好きな方、エスニックな雰囲気が好きな方、ぜひこの空間を楽しんでください。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      'アルテックやゲタマなど、厳選された北欧ヴィンテージ家具。窓から入る自然光が美しい空間です。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason:
            'アルテックのスツール60。フィンランドの職人技が光る、シンプルで機能的な名作',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251004_02.jpg',
        },
        {
          reason:
            'ソルマーニのレザーソファ。イタリアンミッドセンチュリーの傑作。経年変化が美しい',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251004_03.jpg',
        },
        {
          reason:
            'ゲタマのデイベッド。デンマーク製。ソファにもベッドにもなる万能家具',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251004_05.jpg',
        },
      ],
      messageToNext:
        '北欧家具は「使い続けることで価値が生まれる」という哲学があります。この部屋の家具たちも、次の住人と共に新しい歴史を刻んでほしい。ぜひ、毎日の暮らしの中で愛用してください。',
      socialLinks: {
  ...
  },
  {
    ...
    title: 'ロフト付きワンルーム',
    summary:
      '天井高を活かしたロフト付き。限られた空間を最大限に活用したミニマルな暮らし。',
    images: [
    ...
    keyMoney: 1,
    area: '東京',
    location: { lat: 35.7796, lng: 139.718, neighborhood: '荒川区西日暮里' },
    style: 'minimal',
    furniture: ['bed', 'desk', 'storage'],
    condition: 'good',
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '無印良品のベッド。シンプルで寝心地が良い',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251003_top.jpg',
        },
        {
          reason: 'IKEAの収納。必要最小限に厳選',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251003_02.jpg',
        },
        {
          reason: 'ロフトの上から見下ろす景色が好き',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251003_03.jpg',
        },
      ],
      messageToNext:
        '限られた空間を最大限に活用するのは、クリエイティブな挑戦です。この部屋で、あなたらしい暮らし方を見つけてください。',
      socialLinks: {
        youtube: '@taro_films',
      },
    },
  ...
  },
  {
    ...
    summary:
      '無機質なモルタルと温かみのある木のコントラスト。内見即決の人気物件です。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason:
            'モルタル仕上げの天井と壁。無機質な素材感が好きで、これが決め手でした',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251002_01.jpg',
        },
        {
          reason: 'オーク無垢材のフローリング。裸足で歩くと気持ちいい',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251002_02.jpg',
        },
        {
          reason: '大きな窓から入る自然光。照明をつけなくても十分明るい',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251002_03.jpg',
        },
      ],
      messageToNext:
        '建築家として「空間」というものに向き合い続けてきました。この部屋は、私の美意識の集大成です。素材の経年変化も含めて、長く愛してくれる方に引き継ぎたいです。',
      socialLinks: {
  ...
  },
  {
    ...
    title: '陶芸作家のアトリエ兼住居',
    summary:
      'DIYで作り上げた作業スペース。陶芸や手仕事をする方にぴったりの空間。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'DIYで作った大きな作業台。制作に欠かせません',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251001_top.jpg',
        },
        {
          reason: 'オープンシェルフ。完成した作品を並べています',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251001_02.jpg',
        },
        {
          reason: '自然光が入る窓辺。作品の仕上がりを確認するのに最適',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251001_03.jpg',
        },
      ],
      messageToNext:
        'ものづくりには「場」の力が大きいと思っています。この空間で生まれた作品たちは、この部屋の空気を吸って育ちました。次の方にも、創作の喜びを感じてもらえたら。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      'ビビッドな色使いと大人の落ち着きが共存。個性的なインテリアを楽しむ空間。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'イエローのアクセントチェア。部屋のアイコン的存在',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251006_top.jpg',
        },
        {
          reason: 'ブルーのラグ。床に色を入れると空間が引き締まる',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251006_02.jpg',
        },
        {
          reason: 'ピンクのクッション。差し色の使い方がポイント',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251006_03.jpg',
        },
      ],
      messageToNext:
        '色は人の気持ちを動かす力があります。この部屋で過ごすと、なんだか元気が出てくる。そんな空間を次の方にも楽しんでほしいです。',
      socialLinks: {
  ...
  },
  {
    ...
    title: '白を基調としたレザーの空間',
    summary:
      '大きな窓からの自然光と白いインテリア。レザー家具がアクセントの洗練された空間。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '白いソファ。清潔感と高級感の両立',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251005_top.jpg',
        },
        {
          reason: 'レザーのオットマン。足を伸ばしてリラックス',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251005_01.jpg',
        },
        {
          reason: '大きな窓からの自然光。朝の光で目覚める贅沢',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251005_02.jpg',
        },
      ],
      messageToNext:
        '仕事に集中する場所と、心を休める場所。この部屋はその両方を叶えてくれました。次の方にも、このバランスの良さを体感してほしいです。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '築40年の物件をフルリノベーション。新しさと懐かしさが同居する空間。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '壁の珪藻土塗り。自分で塗ったからこそ愛着がある',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251007_02.jpg',
        },
        {
          reason:
            '古材を使ったダイニングテーブル。解体現場からもらってきた材を再利用',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251007_03.jpg',
        },
        {
          reason: 'ヴィンテージの椅子。ネットで見つけて、座面を張り替えた',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/10/room_20251007_04.jpg',
        },
      ],
      messageToNext:
        '築40年の古い物件ですが、リノベーションで生まれ変わりました。古いものには歴史があり、新しいものにはない温かみがあります。この空間の「物語」を引き継いでくれる方を待っています。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '100鉢以上の観葉植物と暮らすボタニカルライフ。都会のオアシスのような部屋です。',
    images: [
    ...
    keyMoney: 1,
    area: '東京',
    location: { lat: 35.6762, lng: 139.671, neighborhood: '世田谷区池尻' },
    style: 'bohemian',
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'ラタンのソファ。植物たちとの相性が抜群',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2024/12/OHZM6604-1-880x586.jpg',
        },
        {
          reason: 'ハンギングプランター。空間を立体的に使えます',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2024/12/OHZM6721-880x586.jpg',
        },
        {
          reason: '木製のプランタースタンド。高低差をつけて植物を配置',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2024/12/OHZM6849-1-880x586.jpg',
        },
      ],
      messageToNext:
        '植物との暮らしは、手間もかかりますが、それ以上の癒しをくれます。100鉢以上の植物たち、ぜひ大切にしてあげてください。水やりスケジュールも引き継ぎます。',
      socialLinks: {
  ...
  },
  {
    ...
    title: '写真家のスタジオ兼住居',
    summary:
      '自然光を活かした撮影スタジオ。白壁と大きな窓が特徴の創作空間です。',
    images: [
    ...
    keyMoney: 1,
    area: '東京',
    location: { lat: 35.6634, lng: 139.687, neighborhood: '目黒区祐天寺' },
    style: 'minimal',
    furniture: ['bed', 'sofa', 'desk'],
    condition: 'excellent',
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '白いバックペーパー。撮影に欠かせない背景',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/OHZM8204-1-880x586.jpg',
        },
        {
          reason: '大きな窓からの自然光。人工光では出せない柔らかさ',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/OHZM8241-1-880x586.jpg',
        },
        {
          reason: 'シンプルなソファ。撮影の合間にリラックス',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/OHZM8437-1-880x586.jpg',
        },
      ],
      messageToNext:
        'この部屋で何百人ものポートレートを撮影しました。窓から入る光の角度、壁の反射、すべてが計算されています。写真を仕事にしている方には最高の環境だと思います。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      'イームズやノグチの名作家具。50〜60年代のデザインを愛する人のための空間。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'イームズのラウンジチェア。言わずと知れた名作',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/08/OHZM0316-1-880x587.jpg',
        },
        {
          reason: 'ノグチのコーヒーテーブル。有機的なフォルムが美しい',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/08/OHZM0469-1-880x587.jpg',
        },
        {
          reason: 'ネルソンのベンチ。シンプルで機能的なデザイン',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/08/OHZM0425-1-880x587.jpg',
        },
      ],
      messageToNext:
        'ミッドセンチュリーの家具は、70年以上前のデザインなのに今も色褪せない普遍性があります。この空間で、名作家具と暮らす贅沢を味わってください。',
      socialLinks: {
  ...
  },
  {
    ...
    title: '天井高4mのロフト空間',
    summary:
      '倉庫をコンバージョンした開放的な空間。天井高を活かしたダイナミックな暮らし。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '特注の鉄製ロフトベッド。空間を有効活用',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/07/OHZM8838-1-880x586.jpg',
        },
        {
          reason: '大きなワークテーブル。チームでのブレストにも対応',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/07/OHZM8863-1-880x586.jpg',
        },
        {
          reason: 'ハンモック。リラックスタイムに欠かせない',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/07/OHZM9016-1-880x586.jpg',
        },
      ],
      messageToNext:
        '天井高4mという空間は、想像以上に気持ちを解放してくれます。大きなアイデアを持っている方、ぜひこの空間で実現に向けて動いてください。',
      socialLinks: {
  ...
  },
  {
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        ...
        {
          reason: '障子。柔らかな光が入ります',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/06/OHZM8602-1-880x587.jpg',
        },
        {
          reason: 'ちゃぶ台と座布団。正座でお茶を点てる時間',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/06/OHZM8682-1-880x587.jpg',
        },
      ],
      messageToNext:
        '和の暮らしは、日々の所作を丁寧にする練習です。この畳の部屋で、ゆっくりとお茶を点てる時間を楽しんでください。茶道具も引き継ぎます。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '原状回復可能なDIYで劇的ビフォーアフター。創意工夫が詰まった空間。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '自作の壁面収納。釘を使わないDIY技術の結晶',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250930_top.jpg',
        },
        {
          reason: 'DIYキッチンカウンター。料理が楽しくなりました',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250930_01.jpg',
        },
        {
          reason: 'リメイクした古家具。廃材を再利用',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250930_02.jpg',
        },
      ],
      messageToNext:
        '賃貸だからこそ、原状回復可能なDIYにこだわってきました。このノウハウ、全部引き継ぎます。次の方も、ぜひ自分らしくカスタマイズしてください。',
      socialLinks: {
  ...
  },
  {
    ...
    keyMoney: 1,
    area: '東京',
    location: { lat: 35.709, lng: 139.6875, neighborhood: '新宿区落合' },
    style: 'modern',
    furniture: ['bed', 'desk', 'storage'],
    condition: 'excellent',
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason:
            '業務用エスプレッソマシン La Marzocco。プロ仕様の味が出せます',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2024/12/OHZM6622-1-880x586.jpg',
        },
        {
          reason: '焙煎機 Aillio Bullet。自家焙煎の香りは格別',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2024/12/OHZM6736-1-880x586.jpg',
        },
        {
          reason: 'ドリップスタンド。ハンドドリップ派にも対応',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2024/12/OHZM6793-1-880x586.jpg',
        },
      ],
      messageToNext:
        'コーヒーは人生を豊かにしてくれます。この空間で、毎朝最高の一杯を淹れてください。器具の使い方もレクチャーします。',
      socialLinks: {
  ...
  },
  {
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '4Kプロジェクター EPSON EH-TW9400。映画館クオリティ',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/OHZM8440-1.jpg',
        },
        {
          reason: '120インチスクリーン。没入感が違います',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/OHZM8273-1.jpg',
        },
        {
          reason: 'リクライニングソファ。長時間の鑑賞も快適',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/OHZM8393-1-880x587.jpg',
        },
      ],
      messageToNext:
        '映画は暗い部屋で、大きなスクリーンで、良い音で観るべきです。この環境を作り上げるのに何年もかかりました。映画好きの方に引き継げたら本望です。',
      socialLinks: {
  ...
  },
  {
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '5口ガスコンロ。同時調理が捗ります',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/06/OHZM8650-1-880x587.jpg',
        },
        {
          reason: '大型オーブン。パンからローストまで対応',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/06/OHZM8717-1-880x587.jpg',
        },
        {
          reason: 'アイランドキッチン。作業効率が段違い',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/06/OHZM8537-1-880x586.jpg',
        },
      ],
      messageToNext:
        '料理は愛情。このキッチンで作った料理で、たくさんの笑顔を見てきました。次の方にも、ここでたくさんの美味しい料理を作ってほしいです。',
      socialLinks: {
  ...
  },
  {
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '天井までの造作本棚。3000冊収納可能',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/OHZM8496-1.jpg',
        },
        {
          reason: '読書用チェア。長時間の読書も快適',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/OHZM8301-1-880x586.jpg',
        },
        {
          reason: 'デスクランプ。目に優しい光で夜の読書も',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/OHZM8361-1.jpg',
        },
      ],
      messageToNext:
        '本は人生を豊かにしてくれます。この3000冊の蔵書、次の方にも読んでいただけたら嬉しいです。静かな時間を大切にできる方に。',
      socialLinks: {
        twitter: '@akira_books',
      },
    },
  ...
  },
  {
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '広いリビング。ヨガマットを広げても余裕',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/07/OHZM8872-1-880x586.jpg',
        },
        {
          reason: '瞑想クッション。心を落ち着ける時間に',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/07/DMA-250421_MN47538.jpg',
        },
        {
          reason: 'アロマディフューザー。香りで空間を整える',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/07/DMA-250421_MN47543.jpg',
        },
      ],
      messageToNext:
        'ヨガは心と体を整える最高の習慣です。この部屋で毎朝プラクティスを続けてきた私の習慣を、次の方にも引き継いでいただけたら。',
      socialLinks: {
  ...
  },
  {
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'バイクリフト。整備が格段に楽になります',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250927_01-2.jpeg',
        },
        {
          reason: '工具棚。必要な工具がすべて揃っています',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250927_02-1.jpg',
        },
        {
          reason: '作業台。細かい作業もしやすい環境',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250927_03-1.jpg',
        },
      ],
      messageToNext:
        'バイクは単なる移動手段じゃない、人生の相棒です。この最高の環境で、あなたも愛車と過ごしてください。工具も全部引き継ぎます。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '犬と猫と暮らすためにカスタマイズした空間。ペットファーストな設計です。',
    images: [
      'https://www.mensnonno.jp/wp-content/uploads/2025/09/01.jpg',
      'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250928_03.jpg',
      'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250928_04.jpg',
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'キャットウォーク。猫たちの遊び場',
          image: 'https://www.mensnonno.jp/wp-content/uploads/2025/09/01.jpg',
        },
        {
          reason: 'ペット用ドア。自由に行き来できます',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250928_03.jpg',
        },
        {
          reason: '洗いやすい床材。お手入れが簡単',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250928_04.jpg',
        },
      ],
      messageToNext:
        'ペットは家族です。この部屋はペットファーストで設計しました。動物好きな方に、この愛情を込めた空間を引き継いでいただけたら嬉しいです。',
      socialLinks: {
  ...
  },
  {
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '20㎡のルーフテラス。都心で空を感じられる贅沢',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250929_01.jpg',
        },
        {
          reason: 'Weber グリル。本格的なBBQが楽しめます',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250929_02.jpg',
        },
        {
          reason: 'ハンモック。テラスでの昼寝は最高',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250929_03.jpg',
        },
      ],
      messageToNext:
        '都心でテラス付きの部屋は本当に貴重です。友人を呼んでBBQ、一人で夜景を眺める時間、両方楽しめるこの空間を次の方にも。',
      socialLinks: {
  ...
  },
  {
    ...
    keyMoney: 1,
    area: '東京',
    location: { lat: 35.705, lng: 139.7187, neighborhood: '新宿区高田馬場' },
    style: 'modern',
    furniture: ['bed', 'desk', 'storage'],
    condition: 'excellent',
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'RTX 4090搭載PC。最高スペックでどんなゲームも快適',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250930_06.jpg',
        },
        {
          reason: '4Kモニター3枚。配信しながらのプレイも余裕',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/09/room_20250930_07.jpg',
        },
        {
          reason: '配信用機材一式。すぐに配信を始められます',
          image:
            'https://www.mensnonno.jp/wp-content/uploads/2025/08/OHZM0473-1-880x1319.jpg',
        },
      ],
      messageToNext:
        'ゲームは真剣にやるから面白い。この環境で、あなたも最高のパフォーマンスを発揮してください。配信のノウハウも教えます。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '漫画の聖地・トキワ荘近く。クリエイターの街で暮らすミニマルな空間。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'コンパクトだけど機能的なデスク。原稿作業に集中できる',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-1526563981109647588/original/b5125a3b-bef2-459a-8f40-3ea1eae7fd82.png',
        },
        {
          reason: '大きなダブルベッド。締め切り前の仮眠に最適',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-1526563981109647588/original/fc57f575-96fc-4304-8235-910a5b74ecf2.jpeg',
        },
        {
          reason: '明るい窓。自然光で作業できるのが嬉しい',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-1526563981109647588/original/90a5e031-8f11-4854-9345-186b2c8925dc.png',
        },
      ],
      messageToNext:
        'トキワ荘の近くで暮らすということは、漫画の歴史の中に身を置くこと。手塚治虫や藤子不二雄が歩いた街で、あなたも夢を追いかけてください。',
      socialLinks: {
        twitter: '@ren_manga',
      },
    },
  ...
  },
  {
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '清潔感のあるベッドルーム。仕事終わりにぐっすり眠れる',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-1453600273857937648/original/3ed272be-c70c-48d5-8c5c-84917c55ac56.jpeg',
        },
        {
          reason: '使いやすいキッチン。簡単な料理なら十分できる',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-1453600273857937648/original/9ca9f361-8cc1-4778-a7ea-f296c2ce4441.jpeg',
        },
        {
          reason: 'バスタブ付き。大阪の夜を楽しんだ後はゆっくり湯船に',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-1453600273857937648/original/853af2c6-920a-4281-a24e-0f02d24ab406.jpeg',
        },
      ],
      messageToNext:
        '新今宮は観光客には見えない、本当の大阪がある場所。地元の人が通う居酒屋、朝から開いてる立ち飲み、ディープな大阪を楽しんでください。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '朝は波の音で目覚め、夕方はサンセットを眺める。サーファーが愛した海辺の1LDK。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: 'リビングから見える海。朝日も夕日も最高のロケーション',
          image:
            'https://a0.muscache.com/im/pictures/miso/Hosting-1515284949501830584/original/fc7eb3e0-6a7d-4c1d-98c2-4eea0caa1baf.jpeg',
        },
        {
          reason: '流木で作ったサーフボードラック。3本まで収納可能',
          image:
            'https://a0.muscache.com/im/pictures/miso/Hosting-1515284949501830584/original/25c3fd35-3d3c-43b7-a8d4-5f5cb17f84f0.jpeg',
        },
        {
          reason: '海から上がってすぐシャワーを浴びられる導線',
          image:
            'https://a0.muscache.com/im/pictures/miso/Hosting-1515284949501830584/original/5ec79b1f-8e2b-417b-a75c-d1f2f53d1a6f.jpeg',
        },
      ],
      messageToNext:
        '湘南の海は毎日表情が違います。波がある日も、凪の日も、それぞれの美しさがある。この部屋で海と共に暮らす喜びを味わってください。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '築100年の町家を現代風にリノベーション。坪庭を眺めながら過ごす静かな京都暮らし。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '坪庭を望む和室。四季折々の景色が楽しめます',
          image:
            'https://a0.muscache.com/im/pictures/prohost-api/Hosting-1034443906084847498/original/e5b1a5c2-8c0e-4f92-a6c1-9c9f8e7d6b5a.jpeg',
        },
        {
          reason: 'リノベーションされた土間キッチン。料理好きにはたまらない',
          image:
            'https://a0.muscache.com/im/pictures/prohost-api/Hosting-1034443906084847498/original/a3d2b1c0-9e8f-4a7b-b5c2-d1e0f9a8b7c6.jpeg',
        },
        {
          reason: '2階の書斎。祇園の街並みを見下ろせる特等席',
          image:
            'https://a0.muscache.com/im/pictures/prohost-api/Hosting-1034443906084847498/original/c7e6d5f4-3a2b-4c8d-9e0f-1a2b3c4d5e6f.jpeg',
        },
      ],
      messageToNext:
        '京都の四季は町家の中にも入り込みます。夏の打ち水、秋の紅葉、冬の雪景色。日本の美しさをこの家で感じてください。',
      socialLinks: {
  ...
  },
  {
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '無印のベッドフレーム。シンプルで寝心地も最高',
          image:
            'https://a0.muscache.com/im/pictures/miso/Hosting-1234567890123456789/original/a1b2c3d4-5e6f-7a8b-9c0d-1e2f3a4b5c6d.jpeg',
        },
        {
          reason: '作業用デスク。必要最小限で集中できる環境',
          image:
            'https://a0.muscache.com/im/pictures/miso/Hosting-1234567890123456789/original/b2c3d4e5-6f7a-8b9c-0d1e-2f3a4b5c6d7e.jpeg',
        },
        {
      ...
      messageToNext:
        'モノが少ないと、掃除も簡単、引っ越しも楽、心も軽い。この部屋でミニマルライフを体験してください。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '冬は雪景色、夏は涼しい風。北海道ライフを満喫できる温かみのある2LDK。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '大きな窓から見える雪景色。冬の朝は格別',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-9876543210987654321/original/d4e5f6a7-8b9c-0d1e-2f3a-4b5c6d7e8f9a.jpeg',
        },
        {
          reason: '北欧スタイルのリビング。厚手のラグで足元も暖か',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-9876543210987654321/original/e5f6a7b8-9c0d-1e2f-3a4b-5c6d7e8f9a0b.jpeg',
        },
        {
          reason: 'ダイニングテーブル。友人を招いて鍋パーティーも',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-9876543210987654321/original/f6a7b8c9-0d1e-2f3a-4b5c-6d7e8f9a0b1c.jpeg',
        },
      ],
      messageToNext:
        '北海道の冬は厳しいけど、その分楽しみ方もたくさんある。スキー、温泉、美味しいご飯。この部屋で北海道ライフを始めてください。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '名古屋の中心地で暮らす。モダンなインテリアと利便性を兼ね備えた1LDK。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '夜景が見えるリビング。仕事終わりのビールが最高',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-1122334455667788990/original/a7b8c9d0-1e2f-3a4b-5c6d-7e8f9a0b1c2d.jpeg',
        },
        {
          reason: '広々としたベッドルーム。質の良い睡眠が取れます',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-1122334455667788990/original/b8c9d0e1-2f3a-4b5c-6d7e-8f9a0b1c2d3e.jpeg',
        },
        {
          reason: '使いやすいキッチン。自炊派にもおすすめ',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-1122334455667788990/original/c9d0e1f2-3a4b-5c6d-7e8f-9a0b1c2d3e4f.jpeg',
        },
      ],
      messageToNext:
        '栄は名古屋の中心。どこに行くにも便利で、飲み屋もカフェも充実。名古屋ライフを満喫してください。',
      socialLinks: {
  ...
  },
  {
    ...
    summary:
      '沖縄の青い海と空。リゾート気分で暮らせるアイランドスタイルの1LDK。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '風が通り抜けるリビング。エアコンなしでも涼しい日も',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-5544332211009988776/original/d0e1f2a3-4b5c-6d7e-8f9a-0b1c2d3e4f5a.jpeg',
        },
        {
          reason: 'ベランダのハンモック。昼寝の特等席',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-5544332211009988776/original/e1f2a3b4-5c6d-7e8f-9a0b-1c2d3e4f5a6b.jpeg',
        },
        {
          reason: '植物に囲まれた寝室。南国気分で目覚められる',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-5544332211009988776/original/f2a3b4c5-6d7e-8f9a-0b1c-2d3e4f5a6b7c.jpeg',
        },
      ],
      messageToNext:
        '沖縄時間でゆったり暮らす幸せ。海、空、風、全部が癒し。この島のパワーを感じながら暮らしてください。',
      socialLinks: {
  ...
  },
  {
    ...
    title: '浅草の静かな隠れ家ホテル',
    summary:
      '浅草の喧騒から離れた静かなエリアに佇む、心落ち着く空間。観光地へのアクセスも良好で、東京の下町情緒を感じながら暮らせます。',
    images: [
    ...
    handoverHost: {
      ...
      whyChoseThis: [
        {
          reason: '浅草寺まで徒歩圏内。朝の静かな参拝が日課になります',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-1504655411015512190/original/9714d4af-7c9e-42e5-95bd-25032a5b30a4.jpeg',
        },
        {
          reason:
            'シンプルで機能的なインテリア。必要なものが全て揃った快適空間',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTUwNDY1NTQxMTAxNTUxMjE5MA==/original/485df1be-863c-4e12-b0b6-bd2e6c1366ae.jpeg',
        },
        {
          reason: '自然光がたっぷり入る明るい室内。心地よい朝を迎えられます',
          image:
            'https://a0.muscache.com/im/pictures/hosting/Hosting-U3RheVN1cHBseUxpc3Rpbmc6MTUwNDY1NTQxMTAxNTUxMjE5MA==/original/f14ce289-8fb1-4c4f-9e67-023b25b4f12b.jpeg',
        },
      ],
      messageToNext:
        '浅草は東京の中でも特別なエリアです。観光地としての賑わいがある一方で、一歩路地に入ると静かな下町の風景が広がります。この部屋で東京の新しい一面を発見してください。',
      socialLinks: {
...
export function convertUserListingToProperty(listing: UserListing): Property {
  const furnitureDescription =
    listing.furniture?.map((f) => furnitureLabels[f] || f).join('、') || '';
...
export const inquiries: Inquiry[] = [
  {
    ...
    reason:
      '植物が大好きで、この部屋の雰囲気に一目惚れしました。レコードプレーヤーもあり、音楽を聴きながら植物の世話をする暮らしに憧れています。',
  ...
  },
  {
    ...
    reason:
      'DJとして活動しており、この防音環境と機材に魅力を感じました。レコードコレクションを引き継げるのも嬉しいです。',
  ...
  },
  {
    ...
    reason:
      'グラフィックデザイナーとして、こういう創作意欲が湧く空間を探していました。',
...
export const hostListings: SellerListing[] = [
  {
    ...
    furnitureDescription:
      '北欧家具一式、ヴィンテージのダイニングテーブル、観葉植物多数',
    whyListing:
      '海外転勤が決まり、大切にしてきた家具を次の人に引き継ぎたいです。',
  ...
  },
  {
    ...
    whyListing:
      '引っ越しすることになり、この部屋での思い出を大切にしてくれる人に譲りたいです。',
    landlordConsent: { hasLandlordConsent: true },
